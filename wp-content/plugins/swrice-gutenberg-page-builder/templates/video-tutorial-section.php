<?php
/**
 * Video Tutorial Section Template
 */
...
<section class="sppm-section sppm-video-tutorial-section">
    ...
    <div class="sppm-video-container">
        ...
        <div class="sppm-video-info">
            <h3 class="sppm-video-title"><?php echo esc_html($video_title); ?></h3>
            <div class="sppm-video-meta">
                <?php if ($video_duration): ?>
                <span class="sppm-video-duration-text">
                    <span class="sppm-duration-icon">⏱️</span>
                    Duration: <?php echo esc_html($video_duration); ?>
                </span>
                <?php endif; ?>
                <span class="sppm-video-type">
                    <?php if ($video_type === 'youtube'): ?>
                        <span class="sppm-platform-icon">📺</span> YouTube
                    <?php elseif ($video_type === 'vimeo'): ?>
                        <span class="sppm-platform-icon">🎬</span> Vimeo
                    <?php else: ?>
                        <span class="sppm-platform-icon">🎥</span> Video
                    <?php endif; ?>
                </span>
            </div>
        </div>
